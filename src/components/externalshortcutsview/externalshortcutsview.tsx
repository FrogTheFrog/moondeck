...
export const ExternalShortcutsView: VFC<Props> = ({ settingsManager, buddyProxy }) => {
  ...
  if (hostSettings === null) {
    ...
    syncButton =
      <DialogControlsSection>
        <DialogControlsSectionHeader>Sync with Buddy</DialogControlsSectionHeader>
        <Field
          label="Sync all Sunshine's shortcuts with Buddy"
          description="Steam client might be restarted afterwards!"
          childrenContainerWidth="fixed"
        >
          <SyncButton shortcuts={shortcuts} moonDeckHostApps={hostSettings.hostApp.apps} hostName={hostSettings.hostName} buddyProxy={buddyProxy} />
        </Field>
      </DialogControlsSection>;
  }
  ...
  return (
    <DialogBody>
      <DialogControlsSection>
        <DialogControlsSectionHeader>What are the External Shortcuts?</DialogControlsSectionHeader>
        <Field
          description={
            <>
              ...
              <br />
              <div>They will not be supported by MoonDeck in any way apart from manually synching/removing them.</div>
              ...
              <div>In this case you can re-sync. If the names do not change, only the launch options will be updates and artwork will remain.</div>
            </>
          }
          focusable={true}
        />
      ...
      <DialogControlsSection>
        ...
        <Field
          label="Purge all External MoonDeck shortcuts!"
